...
namespace BlazorEComm.Server.Migrations
{
    ...
    [Migration("20221221160623_Orders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorEComm.Shared.CartItem", b =>
                {
            ...
            modelBuilder.Entity("BlazorEComm.Shared.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorEComm.Shared.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("BlazorEComm.Shared.OrderItem", b =>
                {
                    b.HasOne("BlazorEComm.Shared.Order", "Order")
                        .WithMany("OrderItems")
